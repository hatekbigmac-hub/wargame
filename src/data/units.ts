...
export const UNIT_DEFS: UnitDef[] = [
  // ---------------------------------------------------------------- land
  {
    ...
    vs: { infantry: 1, armor: 0.35, ship: 0.2, city: 0.8 },
  ...
  },
  {
    ...
    vs: { infantry: 1, armor: 0.6, ship: 0.2, city: 0.8 },
  ...
  },
  {
    ...
    vs: { infantry: 1.2, armor: 0.7, ship: 0.2, city: 1.1 },
  ...
  },
  {
    ...
    vs: { infantry: 0.8, armor: 0.3, air: 2, city: 0.3 },
  ...
  // ---------------------------------------------------------------- naval
  {
    ...
    vs: { infantry: 0.6, armor: 0.4, ship: 0.8, sub: 1, city: 0.3 },
  ...
  },
  {
    ...
    vs: { infantry: 0.6, armor: 0.5, ship: 0.9, sub: 1.3, city: 0.6, air: 1.5 },
  ...
  },
  {
    ...
    vs: { infantry: 0.7, armor: 0.6, ship: 1, sub: 1.5, city: 0.7 },
  ...
  },
  {
    ...
    vs: { infantry: 1, armor: 0.8, ship: 1.1, sub: 0.8, city: 1.2 },
  ...
  },
  {
    ...
    vs: { infantry: 1, armor: 1, ship: 1.1, city: 1.1 },
  ...
  {
    id: 'fighter', name: 'Fighter Squadron', short: 'FTR', domain: 'air', cls: 'air', role: 'Air superiority',
    desc: 'Planned: air superiority fighters.', hp: 120, attack: 20, defense: 10, speed: 160, range: 150, reload: 1.5, detection: 400,
    vs: { air: 1.5, infantry: 0.5, armor: 0.4 }, cost: { money: 500, metal: 120, fuel: 80 }, time: 25, upkeep: { money: 3, fuel: 1.5 },
    projectile: 'bullet', sprite: 'a_jet', size: 26, requires: 'jet_aircraft', future: true,
  },
  {
    id: 'helicopter', name: 'Attack Helicopter', short: 'HEL', domain: 'air', cls: 'air', role: 'Close air support',
    desc: 'Planned: attack helicopters.', hp: 130, attack: 24, defense: 9, speed: 90, range: 140, reload: 1.8, detection: 300,
    vs: { infantry: 1.1, armor: 1.3, ship: 0.6 }, cost: { money: 450, metal: 100, fuel: 60 }, time: 22, upkeep: { money: 2.5, fuel: 1.2 },
    projectile: 'rocket', sprite: 'a_heli', size: 26, requires: 'helicopters', future: true,
  },
];
